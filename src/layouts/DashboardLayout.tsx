  ...
  const navigationStructure: NavigationItem[] = useMemo(() => {
    ...
    structure.push({
      ...
      required: [
        ...
        "settings.manage_variable_center",
        "settings.manage_general",
        "settings.manage_rbac",
        "settings.manage_integration",
        "settings.manage_ai",
      ...
      submenu: [
        {
          ...
          icon: Settings,
          colorClass: navTextClass,
          required: ["settings.manage_general", "system.manage"],
        },
        {
          ...
          icon: Shield,
          colorClass: navTextClass,
          required: ["settings.manage_rbac", "system.manage"],
        },
        {
          name: "Integrations",
          ...
          icon: Zap,
          colorClass: navTextClass,
          required: ["settings.manage_integration", "system.manage"],
        },
        {
          name: "AI Settings",
          ...
          icon: Zap,
          colorClass: navTextClass,
          required: ["settings.manage_ai", "system.manage"],
        },
        {
          name: "Master Data",
          ...
          icon: Database,
          colorClass: navTextClass,
          required: ["settings.manage_master", "settings_master.manage", "system.manage"],
        },
        {
          ...
          icon: Database,
          colorClass: navTextClass,
          required: ["settings.manage_variable_center", "settings.manage_master", "settings_master.manage", "system.manage"],
        },
        {
          name: "Import/Export",
          ...
          icon: Download,
          colorClass: navTextClass,
          required: ["settings.import_data", "settings.export_data", "data.import", "data.export", "system.manage"],
        },
      ],
    });
