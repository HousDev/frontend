...
//                         <button onClick={() => handleEditPost(post)} className="text-blue-600 hover:text-blue-700 p-1" title="Preview"><Eye size={16} /></button>
...
//           {activeTab === 'comments' && renderContentManagement()}
          ...
          <div>
            <div className="mb-4">
              <div className="flex items-center justify-between">
                ...
                <div>
                  <button onClick={() => setShowPostEditor(true) || setSelectedPost(activeCommentsPost)} className="px-3 py-2 border rounded-md mr-2">Edit Post</button>
