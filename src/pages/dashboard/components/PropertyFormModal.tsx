...
//       console.log('Fetched societies from API:', societies);
...
//       console.log('Society options prepared:', options);
...
//   // Fetch society details for auto-fill (includes locality, city, pincode)
...
//       // Step 1: Pehle ID hai ya Name, pata karo
//       let actualSociety = null;

//       // Agar UUID format hai (ID)
...
//       } else {
//         // Agar Name hai, toh pehle societies list mein search karo
...
//       console.log('Found society:', actualSociety);
...
//     // Society Name - Directly use stored society name
...
//         if (initialData.society) {
//           setTimeout(() => {
//             fetchSocietyDetails(initialData.society!);
//           }, 500);
//         }
//       } else {
//         setFormData(prev => ({
...
//             {/* CHANGE THIS - Make Location an INPUT field */}
...
//             {/* CHANGE THIS - Make City an INPUT field */}
//             <Field label="City" required error={errors.city}>
//               <input
//                 type="text"
