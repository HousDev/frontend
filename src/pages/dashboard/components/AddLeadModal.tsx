...
//           initialLead.assigned_executive = String(user.id);
//           initialLead.assigned_executive_name = formatUserName(user);
//         }
...
//                 {newLead.assigned_executive_name && (
//                   <div className="text-xs text-gray-600">
//                     Selected: <span className="font-medium">{newLead.assigned_executive_name}</span>
//                   </div>
//                 )}
...
//                   Available executives: {assignableExecutives.map(e => e.name).join(', ') || 'None'}
//                 </div>
//               </div>
//             );
//           })()}
