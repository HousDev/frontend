...
//   /** Optional: which query param to store the tracking token under. Default: "fltcnt" */
...
// }: Pick<Props, 'url' | 'propertyId' | 'slug' | 'trackingToken' | 'absoluteBase' | 'trackingParamKey'>) => {
...
//   // ✅ Single source of truth for the share/copy URL
//   const shareUrl = buildPropertyUrl({
//     url,
//     propertyId,
//     slug,
//     trackingToken,
