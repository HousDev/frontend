...
//   // pull number from settings if you have it, else fallback
...
//                 onClick={() => setShowQuickContact(true)}   // 👈 open popup
//               >
...
//             <button
//               onClick={() => setShowQuickContact(true)}
//               className="bg-white text-blue-600 px-3 py-2 rounded-xl font-bold hover:bg-gray-100 transition-all shadow-lg"
//             >
//               Get Free Consultation
//             </button>
...
const ServicesPage = () => {
  ...
  // NEW: central handler to open modal with context
  const handleGetStarted = (svc: { id: string; title: string }) => {
    setSelectedService({ id: svc.id, title: svc.title });
    setShowQuickContact(true);
    // Optional analytics:
    // window.gtag?.('event','click_get_started',{service_id:svc.id, service_title:svc.title});
  };
            ...
            {coreServices.map((service) => {
              ...
              return (
                <div key={service.id} className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all group">
                  ...
                  <button
                    className={`w-full py-3 px-6 rounded-xl font-semibold transition-all group-hover:shadow-lg ${isPink ? 'bg-pink-500 text-white hover:bg-pink-600' : `${cm.bg} text-white ${cm.hover}`
                      }`}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-purple-700 text-white rounded-2xl p-8 transform scale-105 shadow-xl">
              ...
              <button
                ...
                className="w-full bg-white text-blue-600 py-3 px-6 rounded-xl font-semibold hover:bg-gray-100 transition-all"
              >
                Choose Premium
              </button>
            </div>
            ...
            <div className="bg-white border-2 border-gray-200 rounded-2xl p-8 hover:border-purple-500 transition-all">
              ...
              <button
                ...
                className="w-full bg-purple-600 text-white py-3 px-6 rounded-xl font-semibold hover:bg-purple-700 transition-all"
              >
                Contact Sales
              </button>
            </div>
