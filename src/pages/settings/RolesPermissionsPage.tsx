...
// interface Role {
//   id: string; // slug: 'admin', 'manager', etc.
//   name: string;
//   description: string;
//   permissions: string[];
//   user_count: number;
...
//       // DB RBAC se merge (agar DB me kuch ho)
//       try {
...
//         // =============================
//         //  FOLLOWUPS PERMSSIONS
//         // ==================================
//         { id: "46", name: "Create Followups", resource: "followup", action: "create", description: "Add followup entries to leads" },
//         { id: "47", name: "Update Followups", resource: "followup", action: "update", description: "Edit existing followup entries" },
//         { id: "48", name: "Delete Followups", resource: "followup", action: "delete", description: "Remove followup entries from leads" },
//         // =============================
