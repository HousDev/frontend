...
//                             className={`flex-1 py-1.5 text-xs font-medium rounded-md transition-all ${filter === tab.id ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-500 hover:text-gray-700'}`}>
//                             {tab.label}
//                         </button>
//                     ))}
//                 </div>
...
//                         return (
//                             <button
//                                 key={conv.id} onClick={() => onSelect(conv)}
            ...
            <div className="px-4 pt-4 pb-3 border-b border-gray-100">
                ...
                <div className="flex flex-wrap gap-1">
                    ...
                    <button
                        ...
                        className={`px-3 py-1.5 text-xs font-medium rounded-lg transition-all ${filter === 'new' ? 'bg-emerald-600 text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'}`}>
                        New
                        <span className="ml-1 text-[10px] opacity-80">({newCount})</span>
                    </button>
