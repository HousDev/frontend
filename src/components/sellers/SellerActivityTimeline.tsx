...
const SellerActivityTimeline = ({ seller }: any) => {
  ...
  const getActivityIcon = (type: string) => {
    switch (type) {
      case 'call': return <Phone className="text-blue-600" size={20} />;
      case 'meeting': return <Users className="text-green-600" size={20} />;
      case 'email': return <Mail className="text-purple-600" size={20} />;
      case 'whatsapp': return <MessageCircle className="text-green-600" size={20} />;
      case 'presentation': return <FileText className="text-orange-600" size={20} />;
      case 'follow_up': return <Bell className="text-blue-600" size={20} />;
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Track all communications and interactions</p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl p-4 text-white">
          ...
          <div className="text-blue-100 text-xs mt-2">All interactions</div>
        </div>
        <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-xl p-4 text-white">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-green-100 text-sm">This Week</p>
              <p className="text-2xl font-bold">{activities.filter(a => {
          ...
          <div className="text-green-100 text-xs mt-2">Recent activities</div>
        </div>
        <div className="bg-gradient-to-r from-purple-500 to-purple-600 rounded-xl p-4 text-white">
          ...
          <div className="text-purple-100 text-xs mt-2">Important tasks</div>
        </div>
        <div className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-xl p-4 text-white">
          ...
          <div className="text-orange-100 text-xs mt-2">Response time</div>
        </div>
      </div>
              ...
              <div className="bg-gray-50 rounded-xl p-4 mb-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <div className="font-medium text-gray-900">{activity.stage.replace('_', ' ').replace(/\b\w/g, l => l.toUpperCase())}</div>
                  </div>
                  <div>
                    <div className="text-xs text-gray-500 uppercase tracking-wider mb-1">Outcome</div>
                    <div className="font-medium text-gray-900">{activity.outcome}</div>
                  </div>
                  <div>
                    <div className="text-xs text-gray-500 uppercase tracking-wider mb-1">Next Action</div>
                    <div className="font-medium text-gray-900">{activity.nextAction}</div>
                  </div>
                </div>
                {activity.remarks && (
              ...
              {expandedActivity === activity.id && (
                <div className="space-y-4">
                  <div className="bg-blue-50 rounded-xl p-4">
                    <h4 className="font-semibold text-blue-900 mb-3">Activity Details</h4>
                  ...
                  <div className="bg-green-50 rounded-xl p-4">
                    <h4 className="font-semibold text-green-900 mb-3">Activity Outcome</h4>
                    <div className="space-y-2">
                      <div>
                        <span className="text-sm text-green-700 font-medium">Outcome:</span>
                        <div className="text-sm text-green-800 mt-1">{activity.outcome}</div>
                      </div>
                      <div>
                        <span className="text-sm text-green-700 font-medium">Next Action:</span>
                        <div className="text-sm text-green-800 mt-1">{activity.nextAction}</div>
                      </div>
                      {activity.remarks && (
                        <div>
                          <span className="text-sm text-green-700 font-medium">Remarks:</span>
                          <div className="text-sm text-green-800 mt-1">{activity.remarks}</div>
                        </div>
                      )}
                    </div>
                  </div>
        ...
        <div className="p-6 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">Record seller interaction and outcomes</p>
            </div>
            <button
              onClick={onClose}
