  ...
  const userColumns: ColumnDef[] = [
    {
      ...
      render: (row) => (
        <div className="flex items-center gap-1.5 whitespace-nowrap min-w-[200px]">
          <span className="font-bold text-gray-900 text-xs">{row.user_name || "N/A"}</span>
  ...
  const logColumns: ColumnDef[] = [
    {
      ...
      render: (row) => (
        <div className="flex items-center gap-1.5 whitespace-nowrap min-w-[200px]">
          <span className="font-bold text-gray-900 text-xs">{row.user_name || "Staff Member"}</span>
        </div>
      ),
    },
    {
    ...
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between bg-white p-2.5 rounded-xl border border-gray-300 shadow-2xs">
        ...
        <div className="text-[11px] font-semibold text-gray-500">
          {viewMode === "user_summary" ? "Showing Per-User Lead Execution & Call Metrics" : "Chronological Activity Feed"}
        </div>
      </div>
