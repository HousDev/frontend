...
import OwnerPropertiesTab from './tabs/OwnerPropertiesTab';
import OwnerInquiriesTab from './tabs/OwnerInquiriesTab';
import OwnerVisitsTab from './tabs/OwnerVisitsTab';
import OwnerLeaseVaultTab from './tabs/OwnerLeaseVaultTab';
import OwnerFinancialsTab from './tabs/OwnerFinancialsTab';
...
export const OwnerAccountPage: React.FC<OwnerAccountPageProps> = ({
  ...
  const tabs = [
    ...
    { id: 'financials', label: 'Rent Tracker & ROI', icon: DollarSign },
          ...
          <div className="relative w-64 max-w-[80vw] bg-white h-full flex flex-col z-10 shadow-2xl animate-in slide-in-from-left duration-200">
            ...
            <div className="p-3 border-t border-gray-200 bg-gray-50 space-y-1.5">
              <button
                ...
                className="w-full flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-lg border border-gray-300 bg-white text-gray-700 font-bold hover:bg-gray-100 text-xs cursor-pointer"
              >
                <ArrowLeft size={13} />
