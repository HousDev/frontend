    ...
    return (
      ...
      >
        ...
        <button
          ...
          className="px-3 py-1 text-xs border border-gray-300 rounded-md bg-white hover:bg-gray-50"
          aria-expanded="true"
      ...
      <div className="flex items-start justify-between">
        <div className="flex-1">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
            ...
            <div className="col-span-1 md:col-span-1">
              <label className="block text-xs font-medium text-gray-700 mb-1">Header Logo</label>

              <div className="flex items-center gap-2">
                <button
                  type="button"
                  onClick={onChooseFile}
                  className="px-3 py-2 border border-gray-300 rounded-lg text-xs bg-white hover:bg-gray-50 truncate max-w-[150px] text-left"
                ...
                {documentSettings.logoUrl ? (
                  <button
                    type="button"
                    onClick={removeLogo}
                    className="px-2 py-1 border border-red-300 rounded-lg text-xs bg-white hover:bg-red-50 text-red-600"
                  >
                    Remove
                  </button>
                ) : null}
        ...
        <div className="ml-4 mt-1">
          <button
            ...
            className="px-2 py-1 text-xs border border-gray-200 rounded-md bg-white hover:bg-gray-50"
            aria-expanded="false"
