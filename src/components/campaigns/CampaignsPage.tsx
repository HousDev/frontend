...
// // INR cost per message by template category
...
//                             <p className="text-xs text-gray-400">Bulk WhatsApp messaging & live tracking</p>
//                         </div>
...
//                             <span className="text-xs font-medium text-blue-600">Total Sent</span>
//                         </div>
//                         <p className="text-xl font-bold text-blue-800">{totalSent.toLocaleString('en-IN')}</p>
//                     </div>
//                     <div className="bg-red-50 rounded-xl p-3 border border-red-100">
//                         <div className="flex items-center gap-2 mb-1">
//                             <AlertCircle size={13} className="text-red-500" />
//                             <span className="text-xs font-medium text-red-600">Total Failed</span>
//                         </div>
//                         <p className="text-xl font-bold text-red-800">{totalFailed.toLocaleString('en-IN')}</p>
//                     </div>
//                     <div className="bg-emerald-50 rounded-xl p-3 border border-emerald-100">
//                         <div className="flex items-center gap-2 mb-1">
//                             <IndianRupee size={13} className="text-emerald-500" />
//                             <span className="text-xs font-medium text-emerald-600">Total Spend</span>
//                         </div>
//                         <p className="text-xl font-bold text-emerald-800">₹{totalCost.toFixed(2)}</p>
//                     </div>
//                 </div>
...
//                                 className={`px-3 py-1.5 text-xs font-medium rounded-lg transition-colors capitalize ${statusFilter === s
...
//                                             <div className={`w-10 h-10 ${sc.bg} rounded-xl flex items-center justify-center shrink-0 border ${sc.border}`}>
...
//                                                     <div>
//                                                         <h3 className="font-bold text-gray-900 text-base">{campaign.name}</h3>
//                                                         <div className="flex items-center gap-2 mt-0.5 flex-wrap">
//                                                             <span className={`inline-flex items-center gap-1 text-xs font-semibold ${sc.color}`}>
...
//                                                                 className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-white bg-emerald-600 rounded-xl hover:bg-emerald-700 transition-colors shadow-sm"
//                                                             >
//                                                                 <Send size={12} /> Launch
//                                                             </button>
//                                                         )}
...
//                                                             <span>Audience:</span>
//                                                             <span className="font-bold text-gray-800">{campaign.total_contacts.toLocaleString('en-IN')}</span>
//                                                         </div>
...
//                                                                 <span className="text-gray-400">@ ₹{rate.toFixed(2)}/msg</span>
//                                                             </div>
//                                                         )}
//                                                     </div>
